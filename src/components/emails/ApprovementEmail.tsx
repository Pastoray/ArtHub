...
interface ApprovementEmailProps {
  email: string
  date: Date
  product: TCoreProduct
}

export const ApprovementEmail = ({
  email,
  date,
  product,
}: ApprovementEmailProps) => {
  return (
    <Html>
      <Head />
      <Preview>Your ArtHub Approvement</Preview>

      <Body style={main}>
        <Container style={container}>
          <Section>
            <Column align='right' style={tableCell}>
              <Text style={heading}>Approvement</Text>
            </Column>
          </Section>
...
export const ApprovementEmailHtml = (props: ApprovementEmailProps) =>
  render(<ApprovementEmail {...props} />, {
    pretty: true,
  })
